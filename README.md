...
This repository is a React + Vite + Tailwind CSS site, plus **Still Connected**, a Phaser 4 + TypeScript game served at `/game` that tells the same story as this CV, the other way round. See [`docs/PROGRESS.md`](./docs/PROGRESS.md) for current state and [`CLAUDE.md`](./CLAUDE.md) for the architecture and conventions.
