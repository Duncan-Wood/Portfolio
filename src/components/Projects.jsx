  ...
  return (
    <div id="projects" className="m-10">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 text-center">
        ...
        >
          ...
          <div className="p-4">
            ...
            <p className="text-gray-700 text-base">
              ...
              purchasing tickets, providing a seamless ticket-buying experience.
            </p>
            <div className="flex justify-center mt-4">
              <a
        ...
        >
          <img
            src={isHoveringCopingCorner ? coping_corner_motion : coping_corner}
            alt="Coping Corner"
            className="w-full h-48 object-cover"
          />
          <div className="p-4">
            ...
            <p className="text-gray-700 text-base">
              ...
              struggling with mental health that provides user authentication,
              resource creation and sharing, and community building.
            </p>
            <div className="flex justify-center mt-4">
              <a
        ...
        >
          ...
          <div className="p-4">
            ...
            <p className="text-gray-700 text-base">
              Dog City is a React web app for dog lovers that lets users browse
              172 dog breeds and view their characteristics and images.
            </p>
            <div className="flex justify-center mt-4">
              <a
